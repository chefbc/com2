...
(() => {
    ...
    var go = (e, r, t, o) => {
        if ((r && typeof r == "object") || typeof r == "function") for (let n of xo(r)) !Yr.call(e, n) && n !== t && Tr(e, n, { get: () => r[n], enumerable: !(o = vo(r, n)) || o.enumerable });
        return e;
    };
    var Gr = (e, r, t) => ((t = e != null ? ho(bo(e)) : {}), go(r || !e || !e.__esModule ? Tr(t, "default", { value: e, enumerable: !0 }) : t, e));
    var qe = Te((X) => {
        (function () {
            ...
            (R = 150),
                ...
                (X.isMatch = n = function (h, b, S) {
                    ...
                    for (T = -1, y = -1; ++y < _; ) {
                        for (k = b.charCodeAt(y), U = S.charCodeAt(y); ++T < g && ((C = h.charCodeAt(T)), !(C === k || C === U)); );
                        if (T === g) return !1;
                    }
                    return !0;
                }),
                (X.computeScore = r = function (h, b, S) {
                    var T, y, g, _, k, U, C, H, I, j, V, re, q, ae, de, te, ve, fe, wr, Oe, Qe, Sr, Er, Or;
                    ...
                    for (Oe = new Array(q), k = new Array(q), Or = w(q, j), V = Math.ceil(u * q) + 5, re = V, C = !0, I = -1; ++I < q; ) (Oe[I] = 0), (k[I] = 0);
                    for (H = -1; ++H < j; ) {
                        ...
                        for (fe = 0, wr = 0, _ = 0, ve = !0, C = !0, I = -1; ++I < q; ) {
                ...
                (X.scoreConsecutives = l = function (h, b, S, T, y, g, _) {
                    var k, U, C, H, I, j, V;
                    for (U = h.length, H = S.length, C = U - y, I = H - g, k = C < I ? C : I, j = 0, V = 0, S[g] === h[y] && j++; ++V < k && T[++g] === b[++y]; ) S[g] === h[y] && j++;
                    return V < k && y--, V === 1 ? 1 + 2 * j : m(V, H, j, _, f(y, h, b, U));
                }),
                (X.scoreExactMatch = d = function (h, b, S, T, y, g, _) {
                    var k, U, C, H, I;
                    for (I = s(y, h, b), I || ((C = b.indexOf(T, y + 1)), C > -1 && ((I = s(C, h, b)), I && (y = C))), U = -1, H = 0; ++U < g; ) S[y + U] === h[U] && H++;
                ...
                (t = new e(0, 0.1, 0)),
                (X.scoreAcronyms = c = function (h, b, S, T) {
                    var y, g, _, k, U, C, H, I, j, V, re;
                    if (((U = h.length), (C = S.length), !(U > 1 && C > 1))) return t;
                    for (y = 0, V = 0, re = 0, I = 0, _ = -1, k = -1; ++k < C; ) {
                        if (((H = T[k]), i(H)))
                    ...
                    return y < 2 ? t : ((g = y === C ? o(h, b, S, y) : !1), (j = m(y, C, I, !0, g)), new e(j, re / y, y + V));
                }),
                (o = function (h, b, S, T) {
                    var y, g, _, k;
        ...
        (function () {
            ...
            (a = qe()),
                ...
                (f = function (c, p, l, v) {
                    ...
                    return (m = x === -1 ? l : R * e(c.slice(x + 1, E + 1), p.slice(x + 1, E + 1), S)), (d = (0.5 * u) / (u + r(c, E + 1, b))), d * m + (1 - d) * l * s(0, t * h);
                }),
        ...
        (function () {
            ...
            (o = qe()),
                ...
                (eo.exports = function (i, f, s) {
                    ...
                    for (
                        m = [], c = s.key, l = s.maxResults, p = s.maxInners, E = s.usePathScoring, x = p != null && p > 0 ? p : i.length + 1, u = c != null, d = E ? r : o, R = 0, h = i.length;
                        R < h && ((a = i[R]), (w = u ? a[c] : a), !(!!w && ((v = d.score(w, f, s)), v > 0 && (m.push({ candidate: a, score: v }), !--x))));
                        R++
                    );
    ...
    var to = Te((gr) => {
        (function () {
            ...
            (a = qe()),
                ...
                (s = a.scoreCharacter),
                (f = a.scoreAcronyms),
                (gr.match = n = function (c, p, l) {
                    var v, d, m, x, w, E;
                    return (
                        (v = l.allowErrors),
                        (w = l.preparedQuery),
                        (x = l.pathSeparator),
                        v || t(c, w.core_lw, w.core_up) ? ((E = c.toLowerCase()), (m = r(c, E, w)), m.length === 0 || (c.indexOf(x) > -1 && ((d = e(c, E, w, x)), (m = i(m, d)))), m) : []
                    );
                }),
                (gr.wrap = function (c, p, l) {
                    var v, d, m, x, w, E, R, h, b;
                    if ((l.wrap != null && ((b = l.wrap), (E = b.tagClass), (h = b.tagOpen), (R = b.tagClose)), E == null && (E = "highlight"), h == null && (h = '<strong class="' + E + '">'), R == null && (R = "</strong>"), c === p))
                        return h + c + R;
                ...
                (r = function (c, p, l, v) {
                    var d, m, x, w, E, R, h, b, S, T, y, g, _, k, U, C, H, I, j, V, re, q, ae, de, te, ve;
                    for (
                        v == null && (v = 0), I = l.query, j = l.query_lw, _ = c.length, C = I.length, E = f(c, p, I, j).score, q = new Array(C), S = new Array(C), x = 0, w = 1, m = 2, d = 3, ve = new Array(_ * C), H = -1, g = -1;
                        ++g < C;
                    ...
                    for (y = -1; ++y < _; )
                        for (V = 0, ae = 0, b = 0, de = p[y], g = -1; ++g < C; )
                            (T = 0),
                                (R = 0),
                                (re = ae),
                                j[g] === de && ((te = o(y, c, p)), (T = b > 0 ? b : u(c, p, I, j, y, g, te)), (R = re + s(y, g, te, E, T))),
                                (ae = q[g]),
                                (b = S[g]),
                                V > ae ? (U = m) : ((V = ae), (U = w)),
                                R > V ? ((V = R), (U = d)) : (T = 0),
                                ...
                                (S[g] = T),
                                (ve[++H] = V > 0 ? U : x);
                    for (y = _ - 1, g = C - 1, H = y * C + g, h = !0, k = []; h && y >= 0 && g >= 0; )
                        switch (ve[H]) {
                            case w:
                                y--, (H -= C);
                                break;
            ...
            (t = ro()),
                ...
                (n = function (u, a) {
                    return (
                        ...
                        u.preparedQuery == null && (u.preparedQuery = f && f.query === a ? f : (f = new e(a, u))),
                        u
                    );
                });
        }.call(oo));
...
` +
  ...
  `)
    ...
    var ee = { onUnhandledError: null, onStoppedNotification: null, Promise: void 0, useDeprecatedSynchronousErrorHandling: !1, useDeprecatedNextContext: !1 };
    var _e = {
    ...
    var Ue = (function (e) {
        ...
        return (
            ...
            (r.prototype.next = function (t) {
                this.isStopped ? Cr(ot(t), this) : this._next(t);
            }),
            (r.prototype.error = function (t) {
                this.isStopped ? Cr(tt(t), this) : ((this.isStopped = !0), this._error(t));
            }),
            (r.prototype.complete = function () {
                this.isStopped ? Cr(rt, this) : ((this.isStopped = !0), this._complete());
            }),
        ...
        ye = (function (e) {
            ...
            function r(t, o, n) {
                var i = e.call(this) || this,
                    f;
                if (O(t) || !t) f = { next: t != null ? t : void 0, error: o != null ? o : void 0, complete: n != null ? n : void 0 };
                else {
                    var s;
                    i && ee.useDeprecatedNextContext
                        ? ((s = Object.create(t)),
                          ...
                          (f = { next: t.next && Mr(t.next, s), error: t.error && Mr(t.error, s), complete: t.complete && Mr(t.complete, s) }))
                        : (f = t);
                }
    ...
    var lt = (function (e) {
        ...
        return (
            (r.prototype.requestAsyncId = function (t, o, n) {
                return (
                    ...
                    n !== null && n > 0
                        ...
                        : (t.actions.push(this),
                          t._scheduled ||
                              (t._scheduled = Me.requestAnimationFrame(function () {
            ...
            (r.prototype.recycleAsyncId = function (t, o, n) {
                ...
                var f = t.actions;
                o != null && ((i = f[f.length - 1]) === null || i === void 0 ? void 0 : i.id) !== o && (Me.cancelAnimationFrame(o), (t._scheduled = void 0));
            }),
            r
        );
    })(er);
    ...
    function N() {
        ...
        var t = ne(e),
            o = dt(e, 1 / 0),
            n = e;
        return n.length ? (n.length === 1 ? F(n[0]) : hr(o)(se(n, t))) : Ce;
    }
    var je = new M(ce);
    ...
    function me(e, r, t) {
        ...
        return (
            e && typeof e == "object"
                ? ((o = e.bufferSize), (f = o === void 0 ? 1 / 0 : o), (n = e.windowTime), (r = n === void 0 ? 1 / 0 : n), (i = e.refCount), (s = i === void 0 ? !1 : i), (t = e.scheduler))
                : (f = e != null ? e : 1 / 0),
            Ft({
                connector: function () {
                    return new ct(f, r, t);
    ...
    function kt() {
        for (var e = [], r = 0; r < arguments.length; r++) e[r] = arguments[r];
        return A(function (t, o) {
            Ct.apply(void 0, z([t], W(e))).subscribe(o);
        });
    }
    function $r() {
        for (var e = [], r = 0; r < arguments.length; r++) e[r] = arguments[r];
    ...
    function Nt(e) {
        ...
        return Se(
            () => (
                ...
                N(D(r, "load"), D(r, "error").pipe(Q(() => Fr(() => new ReferenceError(`Invalid script: ${e}`))))).pipe(
                    P(() => {}),
    ...
    var Zo = new B(),
        Op = Se(() => (typeof ResizeObserver == "undefined" ? Nt("https://unpkg.com/resize-observer-polyfill") : ie(void 0))).pipe(
            P(
                () =>
    ...
    var Np = { drawer: Z("[data-md-toggle=drawer]"), search: Z("[data-md-toggle=search]") };
    var rn = Z("#__config"),
    ...
    function fo(e, r, t) {
        return J(
            ...
            J("button", { class: "md-clipboard--inline", title: Jt("clipboard.copy"), "data-clipboard-text": t ? e.shortcode : `:${e.shortcode}:` }, J("code", null, t ? io(e, r) : `:${io(e, r)}:`))
        );
    }
    function uo(e) {
        let r = `@${e.name}`;
    ...
    function co(e) {
        return J("a", { href: "https://github.com/sponsors/squidfunk?metadata_origin=docs", class: "mdx-sponsorship__item mdx-sponsorship__item--private" }, "+", e);
    }
    function on(e, { index$: r, query$: t }) {
        switch (e.getAttribute("data-mdx-mode")) {
            case "file":
                return Re([t.pipe(xr("value")), r.pipe(P(({ icons: o }) => Object.values(o.data).map((n) => n.replace(/\.svg$/, ""))))]).pipe(
                    P(([{ value: o }, n]) => (0, Qr.filter)(n, o)),
                    Q((o) => r.pipe(P(({ icons: n }) => ({ data: o.map((i) => ({ shortcode: i, url: [n.base, i, ".svg"].join("") })) }))))
                );
            default:
                return Re([t.pipe(xr("value")), r.pipe(P(({ icons: o, emojis: n }) => [...Object.keys(o.data), ...Object.keys(n.data)]))]).pipe(
                    P(([{ value: o }, n]) => (0, Qr.filter)(n, o)),
                    Q((o) =>
                        r.pipe(
                            P(({ icons: n, emojis: i }) => ({
